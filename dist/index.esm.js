...
var Input$1 = styled.input(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"], ["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledBalanceInput = styled(Box)(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"], ["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var StyledInput$1 = styled(Input$1)(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n  background: transparent;\n  border-radius: 0;\n  box-shadow: none;\n  padding-left: 0;\n  padding-right: 0;\n  text-align: right;\n\n  ::placeholder {\n    color: ", ";\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: none;\n  }\n"], ["\n  background: transparent;\n  border-radius: 0;\n  box-shadow: none;\n  padding-left: 0;\n  padding-right: 0;\n  text-align: right;\n\n  ::placeholder {\n    color: ", ";\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var SliderLabel = styled(Text)(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  bottom: 0;\n  font-size: 12px;\n  left: calc(", "%);\n  position: absolute;\n  margin-left: 16px; // offset the bunny butt width\n"], ["\n  bottom: 0;\n  font-size: 12px;\n  left: calc(", "%);\n  position: absolute;\n  margin-left: 16px; // offset the bunny butt width\n"])), function (_a) {
    var progress = _a.progress;
    return progress;
});
var BunnyButt = styled.div(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  background: url(", ") no-repeat;\n  height: 32px;\n  filter: ", ";\n  position: absolute;\n  width: 15px;\n"], ["\n  background: url(", ") no-repeat;\n  height: 32px;\n  filter: ", ";\n  position: absolute;\n  width: 15px;\n"])), bunnyButt, function (_a) {
    var disabled = _a.disabled;
    return (disabled ? "grayscale(100%)" : "none");
});
var BunnySlider = styled.div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 14px);\n"], ["\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 14px);\n"])));
var StyledInput = styled.input(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  cursor: ", ";\n  height: 32px;\n  position: relative;\n\n  ::-webkit-slider-thumb {\n    -webkit-appearance: none;\n    ", "\n  }\n\n  ::-moz-range-thumb {\n    ", "\n\n    background-color: transparent;\n    border: 0;\n  }\n\n  ::-ms-thumb {\n    ", "\n  }\n"], ["\n  cursor: ", ";\n  height: 32px;\n  position: relative;\n\n  ::-webkit-slider-thumb {\n    -webkit-appearance: none;\n    ", "\n  }\n\n  ::-moz-range-thumb {\n    ", "\n\n    background-color: transparent;\n    border: 0;\n  }\n\n  ::-ms-thumb {\n    ", "\n  }\n"])), getCursorStyle, getBaseThumbStyles, getBaseThumbStyles, getBaseThumbStyles);
...
var BarProgress = styled.div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  background-color: ", ";\n  filter: ", ";\n  height: 10px;\n  position: absolute;\n  top: 18px;\n"], ["\n  background-color: ", ";\n  filter: ", ";\n  height: 10px;\n  position: absolute;\n  top: 18px;\n"])), function (_a) {
    var theme = _a.theme;
...
var templateObject_1$l, templateObject_2$a, templateObject_3$7, templateObject_4$3, templateObject_5$3, templateObject_6;
...
var Slider = function (_a) {
    ...
    var labelOffset = progressPercentage - progressPercentage / LABEL_OFFSET;
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React.createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React.createElement(Icon$M, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: '#69552e', textDisabled: '#998c83', textSubtle: '#836a38', borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#be7434", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
...
export { Icon$1h as AddIcon, Alert, Icon$1g as ArrowBackIcon, Icon$1f as ArrowDownIcon, Icon$1e as ArrowDropDownIcon, Icon$1d as ArrowDropUpIcon, Icon$1c as ArrowForwardIcon, Icon$1b as ArrowUpIcon, Icon$1a as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$19 as BinanceIcon, Icon$1j as BlockIcon, Box, Breadcrumbs, Icon$18 as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$15 as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$16 as CardViewIcon, Icon$17 as Cards, GridLayout as CardsLayout, Icon$14 as ChartIcon, Checkbox, Icon$1l as CheckmarkCircleIcon, Icon$13 as CheckmarkIcon, Icon$12 as ChevronDownIcon, Icon$11 as ChevronLeftIcon, Icon$10 as ChevronRightIcon, Icon$$ as ChevronUpIcon, Icon$_ as CloseIcon, Icon$Z as CogIcon, Icon$Y as CommunityIcon, Icon$X as Competition, ConnectorNames, Icon$W as CopyIcon, Dropdown, Icon$1k as ErrorIcon, FallingBunnies, Flex, Heading, Icon$V as HelpIcon, Icon$U as HistoryIcon, IconButton, Image, Icon$1i as InfoIcon, Input$1 as Input, Icon$T as LaurelLeftIcon, Icon$S as LaurelRightIcon, Link, LinkExternal, Icon$R as ListViewIcon, Icon$Q as LogoIcon, Icon$P as LogoRoundIcon, Menu, Icon$O as MetamaskIcon, Icon$N as MinusIcon, Modal, ModalProvider, Icon$M as NoProfileAvatarIcon, NotificationDot, Icon$L as OpenNewIcon, Icon$J as PancakeRoundIcon, Icon$K as PancakesIcon, Icon$I as PlayCircleOutlineIcon, Icon$H as Predictions, Icon$G as PrizeIcon, Progress, Icon$D as ProgressBunny, Radio, Icon$q as RefreshIcon, Icon$F as RemoveIcon, ResetCSS, Icon$w as SearchIcon, Skeleton, Slider, Spinner, Svg, Icon$v as SwapVertIcon, Icon$u as SyncAltIcon, Tag, Icon$A as TestnetIcon, Text, Icon$z as Ticket, Icon$y as TicketRound, Icon$x as TimerIcon, ToastContainer, Toggle, Icon$E as VerifiedIcon, Icon$t as VolumeOffIcon, Icon$s as VolumeUpIcon, Icon$C as WaitIcon, Icon$r as WarningIcon, Icon$B as Won, variants$2 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
